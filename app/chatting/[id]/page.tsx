...
export default async function Chattingpage({params}:{params:{id:string}}){
    ...
    const buyerCollection=await buyerModal.find().populate('id','email contact').lean();   //here as our buyerModal has an id which is the reference of the user so we are using populate to find the email and contact
