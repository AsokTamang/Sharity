...
function ChattingClientpage({ itemID, buyers }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "max-w-2xl mx-auto mt-8 px-4", children: [(0, jsx_runtime_1.jsxs)("div", { className: "mb-4", children: [(0, jsx_runtime_1.jsx)("label", { className: "block text-lg font-semibold mb-2", children: "Select a person to see the inbox:" }), (0, jsx_runtime_1.jsxs)("select", { onChange: (e) => setSelectedBuyer(e.target.value), value: selectedBuyer, className: "w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-400", children: [(0, jsx_runtime_1.jsx)("option", { disabled: true, value: "", children: "-- Select a buyer --" }), buyers.filter((buyer) => buyer._id !== userID).map((buyer) => ((0, jsx_runtime_1.jsxs)("option", { value: buyer._id, children: ["     ", buyer.email, " (", buyer.contact, ")"] }, buyer._id)))] })] }), selectedBuyer && ( /** then when there is a buyer selected for chat then we display the older messages and make the real time chat system ready for the user or owner of item*/(0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col h-[500px] p-4 bg-white rounded-lg shadow-lg border border-gray-200", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex-1 overflow-y-auto space-y-3 mb-4 pr-2", children: [messages.map((msg, index) => ((0, jsx_runtime_1.jsxs)("div", { className: `max-w-[70%] px-4 py-2 rounded-xl ${msg.sender._id === userID
                                    ? 'bg-blue-600 text-white self-end ml-auto'
                                    : 'bg-gray-200 text-black self-start mr-auto'}`, children: [(0, jsx_runtime_1.jsx)("p", { className: "text-sm", children: msg.content }), (0, jsx_runtime_1.jsx)("p", { className: "text-xs mt-1 text-right italic", children: msg.sender.email })] }, index))), (0, jsx_runtime_1.jsx)("div", { ref: scrollRef })] }), (0, jsx_runtime_1.jsxs)("div", { className: "flex items-center gap-2 mt-auto border-t pt-4", children: [(0, jsx_runtime_1.jsx)(input_1.Input, { value: message, placeholder: "Type your message...", onChange: (e) => setMessage(e.target.value), className: "flex-1 px-4 py-2 rounded-lg border border-gray-400 focus:outline-none", type: "text" }), (0, jsx_runtime_1.jsx)(button_1.Button, { onClick: handleSend, className: "px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700", children: "Send" })] })] }))] }));
}
