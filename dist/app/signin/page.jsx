...
function Signin() {
    ...
    const handleSubmit = async () => {
        setLoading(true);
        try {
            const response = await axios_1.default.post("/api/signin", user); //here as we are using the axios we can only retrieve the data or anything returned by our backedn using the . data only
