...
function ChatClientpage({ ownerID, itemID, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { className: "max-w-2xl mx-auto mt-8 px-4", children: [(0, jsx_runtime_1.jsx)("h2", { className: "text-xl font-semibold mb-4", children: "Chat with owner" }), !Hydrated ? (0, jsx_runtime_1.jsx)("div", { children: "Chat Loading..." }) : (0, jsx_runtime_1.jsxs)("div", { className: "flex flex-col h-[500px] p-4 bg-white rounded-lg shadow-md border border-gray-200", children: [(0, jsx_runtime_1.jsxs)("div", { className: "flex-1 overflow-y-auto space-y-3 mb-4 pr-2", children: [messages.map((msg, index) => ((0, jsx_runtime_1.jsxs)("div", { className: `max-w-[70%] px-4 py-2 rounded-xl ${msg.sender._id ===
